...
<div class="page-header">
    <div>
        ...
        <p>Choisissez un article et une quantité</p>
    </div>
</div>
...
<div class="card" style="padding: 1.75rem;">
    <form action="{{ route('cart.store') }}" method="POST">
        ...
        <div class="form-grid">
            ...
            {{-- Aperçu prix --}}
            <div class="form-group full" id="preview" style="display:none;">
                <div style="padding: 1rem 1.25rem; background: var(--accent-light); border: 1px solid #dfc8b5; border-radius: var(--radius); display:flex; gap:2rem; align-items:center; flex-wrap:wrap;">
                    <div>
                        ...
                        <div id="preview-price" style="font-family:'DM Serif Display',serif; font-size:1.4rem; color:var(--accent);"></div>
                    </div>
                    <div>
                        ...
                        <div id="preview-total" style="font-family:'DM Serif Display',serif; font-size:1.4rem; color:var(--accent);"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('cart.index') }}" class="btn btn-outline">Annuler</a>
        </div>
    </form>
</div>
